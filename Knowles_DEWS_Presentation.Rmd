...
against other evidence available to them through classroom observation, 
student interactions, or a short interview with the student.
...
- Including multiple indicators is a benefit (Balfanz)

## What does the research say? Mixture/Latent Variable Models

- Most accurate models evaluated
